...
def predict(prompt, style, audio_file_pth, agree):
    ...
    if language_predicted == "zh":
        ...
        language = 'English'
        if style not in ['default', 'whispering', 'shouting', 'excited', 'cheerful', 'terrified', 'angry',
                         'sad', 'friendly']:
    ...
    with gr.Row():
        with gr.Column():
            ...
            style_gr = gr.Dropdown(
                label="Style",
                info=
                "Select a style of output audio for the synthesised speech. (Chinese only support 'default' now)",
        ...
        with gr.Column():
            ...
            tts_button.click(
                predict, [input_text_gr, style_gr, ref_gr, tos_gr],
                outputs=[out_text_gr, audio_gr, ref_audio_gr])
